...
std::vector<double> Covariance::constructSameTrackJacobian(Track* t1, Track* t2 ){
...
//return LowerDiagonal
float* Covariance::transformSameTrackCov(std::vector<double> oldcov, Track* t1, Track* t2){
